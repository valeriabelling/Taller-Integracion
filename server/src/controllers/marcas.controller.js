...
const getMarcas = async(req, res) => {
    const response = await pool.query('SELECT * FROM marca ORDER BY idmarca ASC');
...
const createMarcas = async(req, res) => {
    ...
    const response = await pool.query('INSERT INTO marca (nombre, estado) VALUES ($1, $2)', [nombre, estado]);
    res.json({
