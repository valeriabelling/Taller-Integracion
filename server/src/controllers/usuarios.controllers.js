...
const updateUsers = async(req, res) => {
    ...
    const response = await pool.query('UPDATE Usuario SET corroElctronico = $1, telefono = $2 WHERE idUsuario = $3', [
        cortreoElectronico,
        telefono,
        idUsuario
    ]);
    res.json('Se ha actualizado de forma correcta los datos del usuario: ${idUsuario}.');
};
